...
class LETOR:
    def __init__(self, model_dir):
        ...
        with open("ir/nfcorpus/train.vid-desc.queries", encoding='utf-8') as file:
            for line in file:
    ...
    def training_prep(self):
        ...
        #grouping by q_id   
        self.q_docs_rel = {}
        with open("ir/nfcorpus/train.3-2-1.qrel") as file:
            for line in file:
    ...
    def building_model(self):
        ...
        with open(os.path.join(self.model_dir, 'lsi_model.sav'), 'wb') as f:
            pickle.dump(self.model, f)
        with open(os.path.join(self.model_dir, 'bow_corpus.dict'), 'wb') as f:
    ...
    def training_ranker(self):
        ...
        with open(os.path.join(self.model_dir, 'lightgbm_model.sav'), 'wb') as f:
